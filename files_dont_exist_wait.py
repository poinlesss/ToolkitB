...
if i == 0:
    ...
    i = 0
    while not emergency_abort and files_exist:
        if file1 and not os.path.exists(arg1):            file1 = ""
        if file2 and not os.path.exists(arg2):            file2 = ""
        if file3 and not os.path.exists(arg3):            file3 = ""
        if file4 and not os.path.exists(arg4):            file4 = ""
        if file5 and not os.path.exists(arg5):            file5 = ""
        if file6 and not os.path.exists(arg6):            file6 = ""
        if file7 and not os.path.exists(arg7):            file7 = ""
        if file8 and not os.path.exists(arg8):            file8 = ""
        if file9 and not os.path.exists(arg9):            file9 = ""
        if file10 and not os.path.exists(arg10):            file10 = ""
